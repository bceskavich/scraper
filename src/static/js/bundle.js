...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storesScraperStore = __webpack_require__(158);

	var _storesScraperStore2 = _interopRequireDefault(_storesScraperStore);

	var _actionsScraperActions = __webpack_require__(174);
	...
	var ScraperApp = (function (_Component) {
	  ...
	  _createClass(ScraperApp, [{
	    ...
	    value: function componentWillUnmount() {
	      _storesScraperStore2['default'].unlisten(this._onChange);
	    }
	  }, {
	    key: 'render',
	    ...
	    key: '_checkForToken',
	    value: function _checkForToken() {
	      var splitPath = location.href.split('&');
	      if (splitPath.length > 1) {
	        var token = splitPath[0].split('access_token=');
	        token = token[token.length - 1];
	        _actionsScraperActions2['default'].setToken(token);
	      }
	    }
	  }, {
	    key: '_onChange',
	    value: function _onChange() {
	      this.setState(_storesScraperStore2['default'].getState().state);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScraperStore = (function () {
	  function ScraperStore() {
	    _classCallCheck(this, ScraperStore);

	    this.bindListeners({
	      onSetToken: _actionsScraperActions2['default'].SET_TOKEN,
	      onSetTerm: _actionsScraperActions2['default'].SET_TERM,
	      onIsScraping: _actionsScraperActions2['default'].IS_SCRAPING
	    });
	  ...
	  _createClass(ScraperStore, [{
	    ...
	    key: 'onIsScraping',
	    value: function onIsScraping(status) {
	      var currentState = this.state;
	...
	exports['default'] = _alt2['default'].createStore(ScraperStore, 'ScraperStore');
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsStateFunctions = __webpack_require__(164);

	var StateFunctions = _interopRequireWildcard(_utilsStateFunctions);

	var _symbolsSymbols = __webpack_require__(165);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _esSymbol = __webpack_require__(166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _eventemitter3 = __webpack_require__(169);
	...
	var ScraperActions = (function () {
	  ...
	  _createClass(ScraperActions, [{
	    ...
	    value: function scrapeData() {
	      ...
	      setTimeout(function () {
	        _this.actions.isScraping(false);
	      }, 1000);
	    }
	  }, {
	    key: 'startScraping',
	    value: function startScraping() {
	      this.actions.isScraping(true);
	      this.actions.scrapeData();
	    }
	  }]);

	  return ScraperActions;
	})();

	exports['default'] = _alt2['default'].createActions(ScraperActions);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var loginPath = 'https://www.facebook.com/dialog/oauth?client_id=' + loginParams.clientId + '&redirect_uri=' + loginParams.redirectUri + '&response_type=' + loginParams.responseType + '&scope=' + loginParams.scope;
